 ...
 */
final class Version20210401100047 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE fiches (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, bac_obteined VARCHAR(255) NOT NULL, situation VARCHAR(255) NOT NULL, old_study VARCHAR(500) NOT NULL, forces VARCHAR(500) DEFAULT NULL, weakness VARCHAR(500) NOT NULL, activity VARCHAR(500) NOT NULL, inscription VARCHAR(1000) NOT NULL, future_job VARCHAR(500) DEFAULT NULL, telling_about_me VARCHAR(1000) DEFAULT NULL, self_express VARCHAR(1000) DEFAULT NULL, speciality VARCHAR(255) DEFAULT NULL, first_language VARCHAR(255) DEFAULT NULL, second_language VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
